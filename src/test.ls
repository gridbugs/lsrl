define ['prelude-ls', \perlin_test_generator, \cell_automata_test_generator, \character, \vec2, \game_state, \cell, \fixture], \
    (prelude, perlin_test_generator, cell_automata_test_generator, character, vec2, game_state, cell, Fixture) ->
